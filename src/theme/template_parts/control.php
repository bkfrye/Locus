<section id="control" class="light-blue tech-info">
  <header>
    <h3><?php the_field('control_title'); ?></h3>
    <div class="header-image" style="background-image: url(<?php echo get_field('control_header_image')['url']; ?>)"></div>
  </header>
  <div class="article-wrapper">
    <?php $articles = get_field('control_articles'); ?>
    <?php if ( $articles ) : ?>
